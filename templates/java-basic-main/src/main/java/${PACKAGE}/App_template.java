...
/**
 * The main application class ${MAINCLASS} for project ${PROJECT_NAME}.
 *
...
public enum AppMode {
  ...
  public ${MAINCLASS}()
  {
    info(${MAINCLASS}.class, "Create application '%s'", messages.getString("app.name"));
  }
  ...
  public void run(String[] args) {
    info(${MAINCLASS}.class, "Application '%s' is running..", messages.getString("app.name"));
    for (String arg : args) {
  ...
  private void init(String[] args) {
    info(${MAINCLASS}.class, "Application '%s' is initializing.", messages.getString("app.name"));
    // default values
  ...
  private void dispose() {
    info(${MAINCLASS}.class, "Application '%s' is ending.", messages.getString("app.name"));
  }
